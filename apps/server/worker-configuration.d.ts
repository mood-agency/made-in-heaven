/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7cce02bf5deaa1e50f5557c2a9361c33)
// Runtime types generated with workerd@1.20260421.1 2026-04-22 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "QueueStateDO";
	}
	interface Env {
		STORAGE: R2Bucket;
		DB: D1Database;
		...
		QUEUE_STATE: DurableObjectNamespace<import("./index").QueueStateDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAGESPEED_API_KEY">> {}
}
